...
\end{tabular}
\caption{\label{tab:nut_anova}Results of the 3-way ANOVA on the linear mixed models for testing the effect of incubation length (Days Elapsed), added leaf litter (Leaf Litter), and added DIN and DIP (Nutrients) on the flux of inorganic nutrients in the litter experiment (see methods for descriptions of the different experiments).}
\end{table}