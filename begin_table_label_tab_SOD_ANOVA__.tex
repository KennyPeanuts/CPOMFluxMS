...
\end{tabular}
\caption{\label{tab:SOD_ANOVA}Results of the 3-way ANOVA on the linear mixed model testing the effect of incubation length (Days Elapsed), added leaf litter (Leaf Litter), and added DIN and DIP (Nutrients) on sediment oxygen demand in the litter experiment (see methods for a description of the different experiments).}
\end{table}